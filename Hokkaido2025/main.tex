...
\includegraphics[width=1.95in]{Figures/pahala.pdf}

\includegraphics[width=3.5in]{Figures/intlmap.png} India, Hawaii, Korea
  }
...
%\vspace{-0.5in}
    ...
    \begin{itemize}
     \item wave optics changes nature of astrophysical observables: Coherent FRB/pulsar/GW      radiation one of the potentially most
      ...
      \item large (1000's) upcoming sample of localized FRBs for
        baryon feedback mapping, absorption system studies
      \item BURSTT under phase 1 commissioning, detected first FRB!
    \end{itemize}
  }
