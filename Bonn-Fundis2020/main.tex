...
\subtitle{Sources near and far}
\author[Boyle and Pen]{Ue-Li Pen \\[8mm] 
}
\date{FUNDIS, MPIfR, January 23, 2020}
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item Cosmic scaling: formation when cosmic horizon=$r_G$,
        $t=10^{-4}$s
      \item $1/\epsilon=10\sigma$ rare (well separated) peaks collapse into PBH
      \item gravitational wave background from formation is redshifted
        to $f=(1+z)c/r_s\sim 30$nHz.
      \item amplitude $\epsilon^4(1+z), \ \ h\sim 10^{-15}$ (Turok \&
        Pen 2016, PRL, 117, 1301)
    \end{itemize}
  }
...
%      \includegraphics[scale=0.32]{Figures/residual2}
      \includegraphics[scale=0.25]{Figures/roebber.png}
    \begin{itemize}
...
%  \subsection{Statistics}
  ...
  \frame{
    ...
    \item 3-D: $\sim \frac{10'}{\rm SNR}$.  Potential for optical
      redshifts of BBH.
