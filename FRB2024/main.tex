...
\title{Coherent FRB lensing: wave effects of FRBs
}
...
\frame{\maketitle}
  ...
  \frame{
    \frametitle{Fast Radio Bursts (and GW)}
    \begin{itemize}
        ...
        \item new regime: microlensing by stars (or DM): direct $H_0$
...
\includegraphics[width=2.2in]{Figures/zhu0834.jpg}
...
\vspace{-0.5in}
    ...
    \begin{itemize}
    \item spatially unresolved, echo of voltage stream delayed by microseconds
    \item search voltage stream, or look for scintillation
    \item observables: time delay, flux ratio
    \item sensitivity down to earth mass
    \item Jow+20
    \end{itemize}
  }
...
\includegraphics[width=4.3in]{Figures/leungml.jpg}
...
\end{center}
  ...
  \frame{
\vspace{-0.5in}
    \frametitle{Microlensing: applications $H_0$}
    \begin{itemize}
    \item measure time delay, flux ratio, source+lens $z$
    \item angular splitting small: resolve with galactic scintillometry
    \end{itemize}
  }
...
\begin{center}
\includegraphics[width=2.2in]{Figures/frbmulens.jpg}
Tsai+24
\end{center}
  }
...
%\vspace{-0.5in}
    ...
    \begin{itemize}
     \item wave optics changes nature of astrophysical observables: Coherent FRB/pulsar/GW      radiation one of the potentially most
      ...
      \item already makes pico-arcsecond images of pulsars
    ...
    \item Picard-Lefschetz theory provides alternative interpretation
      ...
      \item scintillation of stellar microlensing provides direct
        distance measure
    \end{itemize}
  }
