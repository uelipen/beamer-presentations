...
\vspace{-0.5in}
    ...
    \begin{itemize}
        ...
        \item OCE-VIA approved, aiming for a June start
        \item vibrant PhD student grouping: Simard, Main, Berard, summer student J. Xu. (not
          supported by SOSCIP)
%          \vspace{-0.15in}
    \end{itemize}
...
\includegraphics[width=1.9in]{Figures/ARO-DRAO-lf-zoom.png}
  ...
  \frame{
    ...
    \begin{itemize}
        \item vibrant collaboration with Thoth, on-site full group meeting
          in April 2016, next one in August 2016.
        \item submitted ORF-RE proposal to expand scope, waiting to
          hear back in June, substantially strengthened by SOSCIP support.
    \end{itemize}
}
