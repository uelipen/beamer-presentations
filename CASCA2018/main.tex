...
\vspace{-0.5in}
    ...
    \item world leading theoretical astrophysics research 'branding',
      strong alumni grouping: $>$130 faculty ($\sim 80$\%), 20 in Canada
...
%\vspace{-0.5in}
    ...
    \begin{itemize}
        ...
        \item industrial partnerships: IBM, AMD, Huawei $\rightarrow$ MITACS,
          RPP, SOSCIP, ORF-RE
    \end{itemize}
