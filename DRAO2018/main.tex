...
\title{\textcolor{red}{Coherent Multipath Propagation}}
%\subtitle{}
\author[U. Pen]{{
{ 
...
\date{\textcolor{blue}{October 10, 2018}}
...
%\vspace{-0.5in}\hspace{3.5in}\includegraphics[width=0.15\textwidth]{Figures/convergent_geometry.jpeg}
  ...
  \frame{
    \frametitle{Plasma Microscropes}
    \begin{itemize}
    \item PSR B1957+20
    \item coherent lensing 
    \item Main et al 2018
    \end{itemize}

\vspace{-0.9in}\hspace{1.8in}\includegraphics[width=0.55\textwidth]{Figures/main-lens.png}
  }
  \frame{
    \frametitle{Pulsars}
    \begin{itemize}
