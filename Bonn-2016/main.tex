...
\frame{
    ...
    \begin{itemize}
      ...
      \item thought due to turbulence down to scales $D\sim 1000$km
...
\frame{
    ...
    \begin{itemize}
      \item modest number of real, refractive images interfere to
        create interference pattern
      \item observational effects similar to diffraction
...
\frame{
    ...
    \begin{itemize}
      ...
      \item proposed solutions: 1. explosive. strange quarklets (P\'erez-Garc\'ia et
        al 2013), baryonic dark matter (Walker 2001++)
