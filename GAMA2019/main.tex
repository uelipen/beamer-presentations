...
\subsection{History}
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item headless direction ${\bf J J}$: aligned with tidal shear
        field, extended research history
      \item sign of $J$: observable, thought to be in practice
        unpredictable, only very recently studied
 ...
 \frame{
  ...
  \frame{
    ...
    \item exciting week++ ahead of us
    \end{itemize}
  }
\end{document}
