...
\end{comment}
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item precision pulsar distances, precise PTA GW localization
      \item understanding FRB/pulsar emission
      \item understanding nature of lenses
      \item baseband data, VLBI: unique opportunity for GMRT
    \end{itemize}
...
.
  ...
  \frame{
    ...
    \item 
    \item low frequency VLBI: unique window on ISM
    \item potential to use scintillometry for precision pulsar
        distances, orbits, masses, improved PTA, FRB
