...
\end{comment}
  ...
  \frame{
\vspace{-0.5in}
    \frametitle{Origin of Angular Momentum}
    \begin{itemize}
    ...
    \item Tidal Torque Theory: $j_\alpha=\epsilon_{\alpha\beta\gamma} {\cal T}_{\beta \kappa} {\cal T}^+_{\kappa\gamma}$
    \item ${\cal T}=\bar{\phi},{\beta,kappa}$ smoothed tidal field
    \item ${\cal T}^+_\beta,kappa}=\bar{\phi}^+,{\beta,kappa}$ tidal field smoothed on slightly larger scale, Taylor approximated by ${\cal T}^+_{\beta,kappa}=\bar{\rho},{\beta,kappa}$
    \item 
%          \vspace{-0.15in}
    \end{itemize}
  }
