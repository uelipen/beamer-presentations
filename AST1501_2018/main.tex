...
\end{comment}
  ...
  \frame{
    \frametitle{CHIME}
    \begin{itemize}
      \item software telescope in Penticton, BC
      \item fastest survey speed
      \item maps the galaxy, the universe, pulsars, transients, fast radio bursts
    \end{itemize}
%\vspace{-0.1in}
\hspace{-.4in}
...
\vspace{-0.5in}
    ...
    \end{itemize}
\vspace{-0.2in}
\hspace{2in} \includegraphics[width=2.05in]{Figures/FRB_nrao.jpg}
 }
