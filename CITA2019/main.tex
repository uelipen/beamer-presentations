...
\end{comment}
  ...
  \frame{
    \frametitle{Overview}
    \begin{itemize}
      \item New CHIME results: low frequency FRB's, repeater
...
{\tiny image image credit: Jingchuan Yu, Beijing Planetarium}
  ...
  \frame{
    ...
    \end{itemize}
    \vspace{-0.5in}\hspace{2in}\includegraphics[width=0.6\textwidth]{Figures/nature15769-f1.jpg}
  }
...
\frame{
    ...
    \begin{itemize}
      ...
      \item potentially access to km scale information at FRB
      \item coherent wave optics lensing: gravitational
        lensing dream
    \end{itemize}
}
...
\tiny Main+ 2018
 ...
 \frame{
    ...
    \item special environment: many similarities for J1745-2900 GC
      magnetar
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item blind VLBI-localization: CHIME-ARO-GB
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item time to think what one would do with millions of FRBs!
    \end{itemize}
  }
