...
\vspace{-0.25in}
    \frametitle{Sky Maps}
\includegraphics[width=2.5in]{Figures/IQUV.jpg}
The PSF of a purely right circularly polarized gravitational wave point-source located at $\hat{n} = \hat{y}$. The $I, Q, U$ and $V$ maps are constructed for a dense PTA with $N = 1200$ pulsars distributed uniformly on the sky. The maps use the \texttt{HEALPix} pixelization scheme, with $N_{\rm side} = 20$, or $M = 4800$ pixels. 
  }
