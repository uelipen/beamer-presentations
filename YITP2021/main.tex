...
\end{comment}
   ...
   \frame{
    ...
    \begin{itemize}
        ...
        \item spin direction well preserved from initial conditions (Haoran's talk), $\sim$ 0.5 correlation with primordial IC.  Much stronger than shape alignment, {\it conservation of angular momentum}
