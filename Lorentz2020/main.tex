  ...
  \frame{
    ...
    \begin{itemize}
        ...
        \item largest sample from galaxy zoo (13546 $\hat{j}_\parallel$),
          SAMI/MaNGA (1609 $\hat{j}_\perp$), 600 full spin vector
        \item new result (Motloch et al 2020): 3.4$\sigma$ oriented direction correlation
     \end{itemize}
}
...
\vspace{-0.5in}
    ...
    \begin{itemize}
      \item Galaxy spin oriented direction well determined by cosmic structure: Tide and Inertia
