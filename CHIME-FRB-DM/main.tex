...
\vspace{-0.5in}
    ...
    \begin{itemize}
      \item CHIME data at face value requires dominant DM intrinsic to host/MW,
        not intergalactic
      \item need to understand potential instrumental biases
      \item impacts FRB interpretation substantially
      \item incompatible with ASKAP localizations, which at face value implies
        neglible host/MW contributions
     \end{itemize}
  }
