...
\vspace{-0.5in}
    ...
    \begin{itemize}
    \item defies expectations: existence, 
  ...
  \frame{
    ...
    \begin{itemize}
        \item 1st order effect from misalignment of moment of inertia
          and tidal tensor
        \item $\tau=\int \rho \bf{r} \cross \grad \phi$
        \item $\tau_i=\epsilon_{ijk} \int \rho x^j
          x^l \partial_l\partial_k\phi $
        \item $\tau= I \cdot T$
     \end{itemize}
}
...
\vspace{-0.5in}
    ...
    \begin{itemize}
        \item BAO
        \item standard ruler (Alcock-Paczynski effect)
        \item 
     \end{itemize}
  }
