...
\includegraphics[width=4.2in]{Figures/roebber.jpg}
...
\includegraphics[width=\textwidth]{Figures/IQUV.pdf}
        \column{.2\linewidth}
        \caption{
The adjoing $A$ projection PSF of a purely right circularly polarized gravitational wave
...
\includegraphics[width=\textwidth]{Figures/IQUVwpulsardist.jpg}
        \column{.2\linewidth}
        \caption{
Sky map including pulsar term, $r\sim 3 \lambda$
 }
      \end{columns}
    \end{figure}
  }
