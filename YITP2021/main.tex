...
\end{comment}
   ...
   \frame{
    ...
    \begin{itemize}
        ...
        \item spin direction well preserved from initial conditions (Haoran's talk), $\sim$ 0.5 correlation with primordial IC.  Much stronger than shear alignment.
...
\vspace{-0.5in}
    ...
    \begin{itemize}
    \item   $\mu_L &=& \(0.41 \pm 0.53\) \times 10^{-2}$
    \item maximal left is allowed
      \item $\mu_R &=& \(1.99 \pm 0.53\) \times 10^{-2} $
      \item maximal right is disfavoured!
      \item $\mu_- = \(-1.58 \pm 0.75\) \times 10^{-2}$
      \item Parity symmetry is allowed \dSmiley % \DejaSans{ ☺}
     \end{itemize}
  }
