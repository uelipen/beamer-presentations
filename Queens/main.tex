...
\date{\textcolor{blue}{April 6, 2018}}
...
\tiny illustration by Mark Garlick
  ...
  \frame{
    \frametitle{Black Widow PSR B1957+20}
    \begin{itemize}
    \item colloboration of string theorists (path integral optics),
      stellar astronomer, cosmologist
    \end{itemize}
%\vspace{-0.3in}%\hspace{1.8in} 
\includegraphics[width=0.8\textwidth]{Figures/shockdiagram3.pdf}
\vspace{0.5in}
...
\vspace{0.5in}
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item consistent wave optics plasma lensing theory
      \item FRB space time probes: $h\sim 10^{-25}$ sensitivity to
        intergalactic deviations from General Relativity
        (Chameleons).  Yang-Nishizawa-ULP 2017.
    \end{itemize}
  }
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item potential to use scintillometry for precision pulsar
        distances, orbits, masses, improved PTA, intergalactic GR tests.
    \end{itemize}
  }
