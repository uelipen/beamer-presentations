...
\end{comment}
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item achieved $\sim$ km mapping at kpc distance: $\sim 50$ pico
        arcseconds
      \item tools: CHIME, ARO, DRAO, HSA, etc, + HPC, path integrals, etc
    \end{itemize}
    \vspace{-.01in}\hspace{2in}\includegraphics[width=0.3\textwidth]{Figures/IMG-7749-ARO-crop.JPG}
  }
...
%\vspace{-0.95in}
\hspace{1.75in}\includegraphics[width=0.7\textwidth]{Figures/liu-lens.png} 
  }
