...
\title{Classical Mechanics, Quantum Mechanics, Quantum Cosmology: How the universe may have begun
}
...
\frame{\maketitle}
  ...
  \frame{
    ...
    \begin{itemize}
        ...
        \item Kirchoff/Feynnann path integral
        \item stationary phase dominates
        \item classical equation of motion: extremal paths
        \item classical limit independent of wavelength
\vspace{-0.5in}\hspace{2.5in}\includegraphics[width=1.5in]{Figures/fermat.png}
    \end{itemize}
  }
...
\vspace{-0.5in}
    ...
    \item PL Semi-classical limit: consider all imaginary paths
    \end{itemize}
  }
