...
\end{itemize}
\includegraphics[width=2.3in]{Figures/ligo150914.jpg}
}
...
\begin{itemize}
\item Example: Tensor Modes/gravitational waves
\item 2nd Order PDE, two polarizations
\item four distinct solutions per fourier mode: left/right, sine/cosine
\end{itemize}
...
\item regular mode $h_T \propto \sin(k\eta)/k\eta$
...
\vspace{-0.5in}
    ...
    \begin{itemize}
      ...
      \item quadruples mode count, adds fluid d.o.f.      
     \end{itemize}
  }
