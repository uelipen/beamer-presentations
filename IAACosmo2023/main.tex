...
\end{comment}
   ...
   \frame{
    ...
    \begin{itemize}
        ...
        \item recent reports of detection (Hou+22, Philcox 22), upper
          bounds (Motloch+22)
...
%\vspace{-0.5in}
    ...
    \item L-R cross correlation violates statistical isotropy
    \item 2 functions of $k$, huge reduction from 3-D function
    \end{itemize}
    }
  ...
  \frame{
%\vspace{-0.5in}
    \frametitle{From statistics to realizations:}
    \begin{itemize}
    \item need prescription to initialize N-body simulations
    \item e.g. for $f_{NL}$, prescriptions developed for various
      (squeezed, equilateral, ortho) configurations
    \item procedure not unique: for 1 d.o.f. PDF, a small number of
      moments do not specify PDF
    \item minimalist approach: projected Gaussian random field, c.f. Lensing
    \item (note does not generate 3PCF)
    \end{itemize}
    }
...
%\vspace{-0.5in}
    ...
    \begin{itemize}
    \item work done by Hongming Zhu
...
%\vspace{-0.5in}
    ...
    \begin{itemize}
    \item Helical vectors: at large amplitudes, lattice poisson noise generation
    \item Helical tensors: computational shortcut in squeezed limit
      using convolutions
    \item direct correspondence to helical tensor fossils (Masui+17)
    \end{itemize}
    }
...
\frame{
    \frametitle{Helical Tensors}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=2.5in]{Figures/tensorLR.jpg}  
Masui+17
  }
...
\frame{
    \frametitle{Helical Vectors}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=4.5in]{Figures/Helicalvectors.pdf}  
...
\frame{
    \frametitle{Helical Tensors}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=4.0in]{Figures/Gaussian_map.pdf}  
  }
...
\frame{
    \frametitle{Helical Tensors}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=4.0in]{Figures/Tensor_Non-stationary_1e2.pdf}  
  }
...
\frame{
    \frametitle{Helical Tensors}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=4.0in]{Figures/Tensor_Diff_1e2.pdf}  
  }

\frame{
    \frametitle{Helical Tensors}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=3.5in]{Figures/tensorhL.jpg}  
  }
...
\frame{
    \frametitle{Helical Tensors}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=4.0in]{Figures/Tensor_Gaussian_800Mpc.pdf}  
  }

\frame{
    \frametitle{Helical Tensors}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=4.0in]{Figures/Tensor_Non-stationary_1e3_800Mpc.pdf}  
  }
...
\frame{
    \frametitle{Illustris TNG simulations}
%\vspace{-0.5in}
\hspace{-0in}\includegraphics[width=2.9in]{Figures/tngspin.jpg}  
Sheng+23
  }
...
\vspace{-0.5in}
    ...
    \item   $\mu_L = (0.41 \pm 0.53) \times 10^{-2}$  maximal left is allowed
      ...
      \item $\mu_- = (-1.58 \pm 0.75) \times 10^{-2}$  Parity symmetry is allowed 
     \end{itemize}
  }
...
\vspace{-0.5in}
    ...
    \begin{itemize}
      ...
      \item quadratic classification of helical non-Gaussianity: vector,
        tensor
      \item quantified initial conditions and evolution for galaxy
        spin fields and tidal fossils in 
        simulations (see Junsup's talk)
     \end{itemize}
  }
